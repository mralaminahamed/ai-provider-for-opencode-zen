...
Email **alamin.ahamed.dev@gmail.com** with the subject **[SECURITY] AI Provider for OpenCode Zen**.
...
- Any exposure of the stored API key: it is a credential, and it must never reach
  the browser, a log, an error message, or a REST response
...
[github.com/mralaminahamed/ai-provider-for-opencode-zen/security](https://github.com/mralaminahamed/ai-provider-for-opencode-zen/security)
